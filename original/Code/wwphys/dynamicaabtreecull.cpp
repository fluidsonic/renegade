...
)
{
	...
	*/
	...
	Vector3i cellcount;
	cellcount.I = static_cast<int32_t>(worldsize.X / min_grid_cell_size.X);
	cellcount.J = static_cast<int32_t>(worldsize.Y / min_grid_cell_size.Y);
	cellcount.K = static_cast<int32_t>(worldsize.Z / min_grid_cell_size.Z);
