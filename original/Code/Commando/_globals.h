...
#define	APPLICATION_SUB_KEY_NAME_MP_SETTINGS			Build_Registry_Location_String(APP_SUB_KEY, NULL, "WOLSettings")
...
#define	APPLICATION_SUB_KEY_NAME_SERVER_LIST			Build_Registry_Location_String(APP_SUB_KEY, NULL, "ServerList")
