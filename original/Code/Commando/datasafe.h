...
#else
	// Per-instantiation static variable: each template instantiation gets a unique address
	static volatile char _type_unique_marker = 1;
	instruction_pointer = (unsigned long)(uintptr_t)(&_type_unique_marker);
#endif
