...
public:
   ...
   virtual void			Get_Obj_Space_Bounding_Box(AABoxClass & box) const;
	...
	void						Set_Far_Attenuation_Range(double fStart, double fEnd)				{ FarAttenStart = static_cast<float>(fStart); FarAttenEnd = static_cast<float>(fEnd); }
	void						Get_Far_Attenuation_Range(double& fStart, double& fEnd) const	{ fStart = FarAttenStart; fEnd = FarAttenEnd; }
	void						Set_Near_Attenuation_Range(double nStart, double nEnd)			{ NearAttenStart = static_cast<float>(nStart); NearAttenEnd = static_cast<float>(nEnd); }
