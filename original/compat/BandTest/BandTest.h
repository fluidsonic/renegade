// BandTest/BandTest.h — macOS compat stub
// BandTest was a Windows DLL for bandwidth detection. Detect_Bandwidth() is
// stubbed in commando_stubs.cpp. This header just provides the types.
#pragma once
...
BANDTEST_API unsigned long Detect_Bandwidth(unsigned long server_ip, unsigned long my_ip,
    int retries, int& failure_code, unsigned long& downstream, unsigned long api_version,
