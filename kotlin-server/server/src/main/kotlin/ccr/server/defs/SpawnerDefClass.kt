...
class SpawnerDefClass(
    ...
    companion object {
        ...
        fun load(
            ...
            val scriptNames = varsReader.findAllMicroChunks(MCID_SCRIPT_NAME).map { readSpawnerString(it) }
            val scriptParams = varsReader.findAllMicroChunks(MCID_SCRIPT_PARAMETERS).map { readSpawnerString(it) }
        ...
        private fun readSpawnerString(bytes: ByteArray): String {
